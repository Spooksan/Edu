  ...
  return (
    <Container>
      <Row className="categories-super-card">
        ...
        <Col xs={8} lg={8}>
          <div>
            <p1>Gamification: Motivation Psychology & The Art of Engagement</p1>
          </div>
          <div>
            <p>
              Learn how to motivate and engage anyone by learning the psychology
              that underpins human behaviour.
            </p>
          </div>
          <div>
            <span>
      ...
      <Row className="categories-super-card">
        ...
        <Col xs={8} lg={8}>
          <div>
            <p1>Psychology of Diversity and Unconscious Bias</p1>
          </div>
          <div>
            <p>
      ...
      <Row className="categories-super-card">
        ...
        <Col xs={8} lg={8}>
          <div>
            <p1>Diploma in Modern Applied Psychology (DMAP.)</p1>
          </div>
          <div>
            <p>
              Learn how to motivate and engage anyone by learning the psychology
      ...
      <Row className="categories-super-card">
        ...
        <Col xs={8} lg={8}>
          <div>
            <p1>Be Happier with Positive Psychology</p1>
          </div>
          <div>
            <p>
              Learn how to motivate and engage anyone by learning the psychology
